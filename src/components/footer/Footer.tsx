...
const Footer = () => {
  return <div className='bg-[#F4F6F8] w-full z-20 relative flex flex-col items-center gap-4 text-[#1b304a] pt-8 border-t-2 border-solid border-gray-200 mt-20 font-["SUIT"]'>
