        ...
        <div className="flex flex-col items-center xs:flex-row xs:items-start text-lenssisGray">
          ...
          <div className="w-full xs:w-2/5 xs:max-w-[440px] text-base ">
            ...
            <div className="flex gap-4 flex-col xs:flex-row items-center w-full justify-between mt-4">
              ...
              <button className="border border-solid border-lenssisDark py-2 w-full xs:w-[220px] rounded-md text-lenssisDark text-base h-10 font-semibold">
                선택상품구매
              </button>
              {/* onClick시 모든 상품을 주문페이지에 request하는 로직 작성해야 함 */}
              <Link
                to="/payment"
                className="text-center border border-solid border-transparent bg-lenssisDark py-2 w-full xs:w-[220px] rounded-md text-white text-base h-10 font-semibold"
              >
                전체상품구매
              </Link>
            </div>
