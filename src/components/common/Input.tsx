  ...
  if(double){
    return (
      <div className='flex flex-col justify-center my-[30px] w-full h-fit gap-2'>
       ...
       <input className={`grow h-${inputHeight} border border-solid border-gray-200 rounded-md max-w-${inputWidth} pl-2 focus:outline-1 focus:outline-[#ABC8DF] placeholder-gray-400/60`} type={type} placeholder={placeholder} disabled={readonly} />
       <input className={`grow h-${inputHeight} border border-solid border-gray-200 rounded-md max-w-${inputWidth} pl-2 focus:outline-1 focus:outline-[#ABC8DF] placeholder-gray-400/60`} type={type2} placeholder={placeholder2} />
       </div>
      </div>
    );  
  }
  if(!double){
    return (
      <div className='flex flex-col justify-center my-4 gap-2'>
       ...
       <input className={`w-full h-${inputHeight} border border-solid border-gray-200 rounded-md max-w-${inputWidth} pl-2 focus:outline-1 focus:outline-[#ABC8DF] placeholder-gray-400/60`} type={type}  placeholder={placeholder} />
       </div>
      </div>
      )  
  }
