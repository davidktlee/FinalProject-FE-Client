...
export const colors = [
  { type: 'color', color: '#a76c27' },
  { type: 'color', color: '#e5d0d0' },
  { type: 'color', color: '#6e3b3b' },
  { type: 'color', color: '#3a3a3a' },
  { type: 'color', color: '#f2ead1' },
  { type: 'color', color: '#b9b9b9' },
  { type: 'color', color: '#7ea7cd' },
  { type: 'color', color: '#8ca171' }
]
