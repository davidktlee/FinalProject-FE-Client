              ...
              <>
                {currentPost &&
                  currentPost.map((event: InEventMainList) => (
                    <div
                      key={event.eventId}
                      className="relative w-full rounded-xl xs-max:h-[215px] flex flex-col my-2 shadow-basic hover:cursor-pointer"
                    ...
                    >
                      ...
                      />
                      {event.topFixed === 0 && (
                        <span className="absolute bottom-[58px] right-2">
                          <svg
                            width="21"
                            height="21"
                            viewBox="0 0 21 21"
                      ...
                      <div className=" h-[95px] rounded-b-xl ml-2 pt-4">{event.eventTitle}</div>
                    </div>
                  ))}
              </>
            )}
